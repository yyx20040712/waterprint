...
- last_dispatch_utc: 2026-09-24T20:14:09.097Z <!-- E2E-2 批 2 重发 2026-09-25：首发执行者 37min 零 rollout 死胎（首个模型调用未完成）→ 四条件重判全过后重发；坐标+键盘通道三回读全过（chip=智水蓝图、GLM-5.3、指令逐字落框+echo）——status 保持 READY 待执行者认领 -->
