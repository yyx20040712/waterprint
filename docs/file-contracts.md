...
| `server/waterprint_server/routers/projects.py` | 项目 CRUD+生命周期八端点（薄协议转换，231 行——P0-1：CreateProjectRequest +name/ProjectSummaryResponse +name；P0-3：validate 端点可选 body=待存草稿校验；P2 生命周期批 2026-09-12：copy/rename/DELETE 三端点+RenameProjectRequest/DeleteOutcomeResponse） | pydantic 请求 | 响应=服务 dataclass |
