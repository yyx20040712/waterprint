...
| `server/waterprint_server/routers/projects.py` | 项目 CRUD 五端点（薄协议转换，176 行——P0-1：CreateProjectRequest +name/ProjectSummaryResponse +name） | pydantic 请求 | 响应=服务 dataclass |
