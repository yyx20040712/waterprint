...
| `server/waterprint_server/routers/projects.py` | 项目 CRUD 五端点（薄协议转换，181 行——P0-1：CreateProjectRequest +name/ProjectSummaryResponse +name；P0-3：validate 端点可选 body=待存草稿校验） | pydantic 请求 | 响应=服务 dataclass |
