...
| `server/waterprint_server/services/scene.py` | 场景图用例（FE1：最近结果集取数[exports 同款模式复制]/假设合成视图[worker._build_env 同款]/core.build_scene 纯投影+AUDIT2 FIX1 C-1 stale 旗标[SceneResponse=四字段+stale]；无结果 404/工况非法 422/确定性继承，151 行） | 项目 id+工况键 | SceneResponse |
