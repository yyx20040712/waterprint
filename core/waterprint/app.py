...
#
# 【B3 R1 拆分注记】（2026-09-05）：装配域（InvalidAssemblyError/
#   _endpoint/_edges/AssembledGraph/_checked_units_eligibility/
#   _FACTOR_SHARED_PREFIX/_unit_params/_CoefficientsUnit/assemble/
#   _check_grid_hits）迁 app_assembly.py 伴生件（app_enumeration 先例
#   第二例），本文件顶部显式符号清单再导入（禁 import *）；上方规格
