"""细格栅单元包根：白名单导出（municipal_xigeshan）。
...
#
# 【身份】UNIT_ID = "municipal_xigeshan"；业务线：市政污水线；
#   旧系统对应 mod：xigeshan（迁移交叉对照，非依据）。
...
from waterprint.units_lib.municipal.xigeshan.compute import make_unit
from waterprint.units_lib.municipal.xigeshan.manifest import UNIT_ID, manifest
