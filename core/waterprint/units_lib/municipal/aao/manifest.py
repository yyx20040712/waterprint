...
manifest = load_manifest(
    {
        ...
        "params": [
            ...
            # h2 带 4.0~6.0=GB §7.6.5（廊道式有效水深可采用 4.0m~6.0m）+
            # §7.6.39（SBR 水深同带）条文级确证（批3a D-1，批3b 2026-09-26）；
            # ratio_lb 带 2.0~3.0=包络矩形口径≠GB §7.6.39 单廊道口径（连续
            # 进水 2.5:1~4:1）——repo 带维持（D-2 案乙，追认 2026-09-26）
            {
                "field_id": "h2",
                "label_zh": "有效水深",
                "dim": "LENGTH",
