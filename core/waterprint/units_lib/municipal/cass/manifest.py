...
manifest = load_manifest(
    {
        ...
        "out_dims": [
            ...
            {"field_id": "v_load", "dim": "VOLUME", "label_zh": "负荷法主反应区容积"},
            {"field_id": "v_selector", "dim": "VOLUME", "label_zh": "生物选择区容积"},
            {"field_id": "v_bio", "dim": "VOLUME", "label_zh": "生物反应总容积"},
            {"field_id": "h_draw_max", "dim": "LENGTH", "label_zh": "滗水深度上限"},
            {"field_id": "a_draw", "dim": "AREA", "label_zh": "滗水控制单池面积"},
            {"field_id": "a_load", "dim": "AREA", "label_zh": "负荷法单池面积"},
            {"field_id": "a_pool", "dim": "AREA", "label_zh": "单池水面面积"},
            ...
            {"field_id": "o2_denit", "dim": "MASS", "label_zh": "反硝化供氧回收"},
            {"field_id": "o2_total", "dim": "MASS", "label_zh": "总需氧量"},
            {"field_id": "ns_act", "dim": "DIMENSIONLESS", "label_zh": "实际污泥负荷"},
            {"field_id": "h_pool", "dim": "LENGTH", "label_zh": "池总高"},
