...
manifest = load_manifest(
    {
        ...
        "params": [
            ...
            {"field_id": "l_tube", "label_zh": "斜管长度", "dim": "LENGTH", "default": 1.0},
            {"field_id": "h_clear", "label_zh": "清水区高度", "dim": "LENGTH", "default": 1.2},
            {"field_id": "h_buffer", "label_zh": "斜管下布水区高", "dim": "LENGTH", "default": 1.2},
            {"field_id": "h_thick", "label_zh": "浓缩泥区高", "dim": "LENGTH", "default": 2.0},
            {
