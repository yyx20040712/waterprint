...
#      单项），人工/维修/污泥处置显式挂账不造零值键；吨水指标
#      （元/m³）挂账后移（无规范全厂流量键——终裁 D4 维持）。折旧/
#      资本摊销=批6c 2026-09-26 LCC 面处置（joint_enumeration/
#      final_eval.py capex_annualized 展示维度——概算不在 summary 平键
#      链，折旧随 capex 装配在比选面承载；AUD-W11 后半收口）。
#
