/**
 * 投影层纯函数测试·核心面（B3 R6 三分自 projectScene.test.ts）：版本门/
 * kind 完备/摆置确定性/语义 token/root 一致性五 describe（node 环境——
 * 零 WebGL 依赖）。
 *
...
import { fixture, VERSION, type FixtureNode } from "./projectSceneFixtures";
import {
