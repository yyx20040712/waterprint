 ...
 * 输出:  导出动作（useExportDxf mutation：2xx→浏览器下载+列表刷新；
 *        409→Modal 二选一[仍导出旧结果 force 重发 vs 先重算]；
 *        404→「先提交计算」引导；501/网络错→message 分级呈现）
 *
 * 规格说明（FE9 批 6b 段七，D7/D8；骨架冻结规格「stale 守门交互」落点）：
