...
| coefficients | 0.2.0（核心三单元批：chuchenchi/aao/erchunchi 系数+去除率共 60 条新增，AI 起草 2026-08-25 数据策略 v2 工程常用范围口径，**领域专家批量追认待补**；0.1.0 三单元 60 条已签字不扰动） | M1（0.1.0 签字）/M2（0.2.0 追认） |
